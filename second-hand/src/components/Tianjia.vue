...
<div class="box">
    ...
    <div class="box1">
        ...
        <div class="bottom">
            <el-button class="mbt" type="primary" @click='Upload()'>确认添加</el-button>
            <el-button class="mbt" type="info">取消</el-button>
            <p class="warn">商品添加后需要经管理员审核方可进入市场流通！</p>
        </div>
    </div>
</div>
</template>
...
export default {
    ...
    methods:{
      async Upload(){
            ...
            const {data: res} = await request.post('/user/addCommodity',this.dataImage1,{
                headers: {
